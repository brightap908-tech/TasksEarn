...
- [Proof submission upload performance](proof-upload-performance.md) — keep image preparation and post-commit work off the synchronous submission response path.
