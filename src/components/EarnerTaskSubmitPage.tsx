        ...
        <div>
          ...
          {compressing ? (
            ...
            <div className="rounded-xl border-2 border-dashed border-blue-300 bg-blue-50/40 p-6 text-center">
              ...
              <p className="text-[11px] font-bold text-blue-600">Processing image…</p>
            ...
            <>
              ...
              */}
              ...
              >
                {/*
                  The input is hidden visually but remains accessible.
                  "hidden" (display:none) is safe here because the label
                  association — not a pointer event — opens the picker.
                  Resetting value via ref after every attempt lets the
                  same file be re-selected without special tricks.
                */}
                <input
                  ref={fileInputRef}
