        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => onNavigate("home")}>
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500 text-white font-bold text-lg font-display">
                ₦
              </div>
              <span className="font-display text-lg font-bold text-white tracking-tight">
                {platformName}<span className="text-blue-500">.ng</span>
              </span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <span onClick={() => onNavigate("home")} className="hover:text-blue-400 cursor-pointer transition-colors flex items-center gap-1.5">
                  Home page
                </span>
              </li>
              <li>
                <span onClick={() => onNavigate("about")} className="hover:text-blue-400 cursor-pointer transition-colors flex items-center gap-1.5">
                  About TasksEarn
                </span>
              </li>
              <li>
                <span onClick={() => onNavigate("faq")} className="hover:text-blue-400 cursor-pointer transition-colors flex items-center gap-1.5">
                  <HelpCircle className="h-3.5 w-3.5 text-blue-500" /> FAQ & Help
                </span>
              </li>
              <li>
                <span onClick={() => onNavigate("contact")} className="hover:text-blue-400 cursor-pointer transition-colors flex items-center gap-1.5">
                  Contact Support
                </span>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <span onClick={() => onNavigate("terms")} className="hover:text-blue-400 cursor-pointer transition-colors flex items-center gap-1.5">
                  <FileText className="h-3.5 w-3.5 text-amber-500" /> Terms of Service
                </span>
              </li>
              <li>
                <span onClick={() => onNavigate("privacy")} className="hover:text-blue-400 cursor-pointer transition-colors flex items-center gap-1.5">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              ...
              {settings.whatsappGroup && (
                <li className="flex items-center gap-2">
                  <span className="text-blue-500 shrink-0 font-bold text-[14px]">💬</span>
                  <a href={settings.whatsappGroup} target="_blank" rel="noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline font-semibold flex items-center gap-1">
